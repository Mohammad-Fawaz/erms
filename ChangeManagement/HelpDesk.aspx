<%@ Page Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="HelpDesk.aspx.cs" Inherits="HelpDesk" Title="HelpDesk" %>
                            ...
                            <form>
                                <div class="row gx-3 mb-3">
                                    <div class="col-md-6">
                                        <div class="btn-group" role="group">
                                            ...
                                            <asp:Button ID="btnNew" runat="server" Text="New Request" CssClass="btn btn-outline-primary m-1" OnClick="btnNew_Click" Visible="false" />
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-6" runat="server" id="divRequest" visible="false">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <asp:ImageButton ID="btnFinds" runat="server" AlternateText="Find" CssClass="btn btn-outline-primary ms-2" ImageUrl="~/images/search-icon.png" OnClick="btnFind_Click" Visible="false" />
                                        </div>
                                    </div>
                                    <!-- Form Group (Status)-->
                                    <div class="col-md-6" runat="server" id="divtxtStatus" visible="false">
                                        <label class="small mb-1" for="txtStatus">Status <span class="red">*</span></label>
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-6" runat="server" id="divRequestType" visible="false">
                                        <label class="small mb-1" for="txtStartDate">Request Type <span class="red">*</span></label>
                                        <%--OnSelectedIndexChanged="AppSecProfile_SelectedIndexChanged"--%>
                                        <asp:DropDownList runat="server"  AutoPostBack="true" ID="ddlRequestType" CssClass="form-select">
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-6" runat="server" id="divucDateStart" visible="false">
                                        ...
                                        <asp:TextBox runat="server" ID="ucDateStart" placeholder="MM/dd/YYYY" CssClass="form-control datepicker" type="text"></asp:TextBox>
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-6" runat="server" id="divSupervisor" visible="false">
                                        ...
                                        <asp:DropDownList ID="ddlSupervisor" CssClass="form-select" runat="server">
                                        </asp:DropDownList>
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-6" runat="server" id="divtxtDueDate" visible="false">
                                        ...
                                        <asp:TextBox runat="server" ID="txtDueDate" placeholder="MM/DD/YYYY" CssClass="form-control datepicker" type="text"></asp:TextBox>
                                    ...
                                    <div class="col-md-6" runat="server" id="divProject" visible="false">
                                        <label class="small mb-1" for="inputDescription">Project <span class="red">*</span></label>
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-lg-12" runat="server" id="divtxtDescription" visible="false">
