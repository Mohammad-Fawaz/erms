                    ...
                    <div class="card-body">
                        ...
                        OnRowDataBound="grdMyTasks_RowDataBound" AutoGenerateColumns="false">
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="WATStatus" HeaderText="Status"/>
                        ...
                        OnRowDataBound="grdProjects_RowDataBound" AutoGenerateColumns="false">
                                ...
                                <div class="accordion-item" runat="server" id="divhlnkWFTasks" visible="true">
                                    ...
                                    <div id="panelsStayOpen-collapseThree" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingThree">
                                     ...
                                     CssClass="table table-bordered table-condensed table-responsive table-hover"
                                               OnRowDataBound="gvNotes_RowDataBound" AutoGenerateColumns="false">
                                                <Columns>
                                                                ...
                                                                <asp:TemplateField>
                                                                    <ItemTemplate>
                                                                       <asp:HyperLink ID="hlkAction" runat="server">
                                                                        ...
                                                                        <asp:HiddenField ID="HfDocID" runat="server" Value='<%# Eval("HD_ID") %>'/>
                                                                ...
                                                                <asp:BoundField DataField="HD_ID" HeaderText="HD ID"/>
