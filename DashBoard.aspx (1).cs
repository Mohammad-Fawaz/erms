...
public partial class DashBoard : System.Web.UI.Page
{
    ...
    private void LoadWorkFlowTasks()
    {
        ...
        string query = @"SELECT WATID, TaskID, RefType, RefNum, Priority, TaskDesc, BFinish, WATType, WFAssnTo FROM ViewWFTasks WHERE(WFActive <> 0) AND(WATActive <> 0) AND (WFAssnTo = " + _EmpId + ") ORDER BY BFinish, TaskID";
    ...
    private void LoadProjects()
    {
        ...
        string query = @"SELECT ProjNum, ProjName, Status, ActualStart, PlannedFinish FROM ViewProjects WHERE ProjStatus NOT IN ('CLS') ORDER BY PlannedFinish DESC";
        _dt = DataAccess.GetRecords(query);
    ...
    private void LoadReports()
    {
        ...
        try
        {
            ...
            using (DataTable _tempMyReports = DataAccess.GetRecords(DataQueries.GetMyReports(ReportID)))
            {
    ...
    private void LoadHelpTickets()
    {
        ...
        Int32 COID = 0; //for check---
            ...
            using (DataTable _tempAddedNotes = DataAccess.GetRecords(DataQueries.getDashBoardDataHelpDesk()))
