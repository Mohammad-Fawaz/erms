...
Function GetBOMRpt(sParam)
	...
	If (sParam <> "") Then
		...
		If Not (CN Is Nothing) Then
			...
			'If (rsBOM1.State = adStateClosed) Then rsBOM1.Open
		'rsBOM1.Open
			'If Not ((rsBOM1.BOF = True) or (rsBOM1.EOF = True)) Then
			''	rsBOM.MoveFirst
				...
				'	If (sRef <> "") And (sRef <> "-") Then
					'	sSQL = GetGloviaSQL("BOM2", sRef)
					'	sSQL = Replace( sSQL, "*", Chr(37), 1, -1, 1)
					'	Set rsBOM2 = CN.Execute(sSQL, nRecs, 1)
				'		If (rsBOM2.State = adStateClosed) Then rsBOM2.Open
				'					
				'		If Not ((rsBOM2.BOF = True) And (rsBOM2.EOF = True)) Then
					'		rsBOM2.MoveFirst
							'Do
					'			sBOM = sBOM & vbCrLf & "      <tr>"
				...
				'		Else
				'			sBOM = sBOM & vbCrLf & "      <tr>"
				'			sBOM = sBOM & vbCrLf & "        <td colspan='5'><font face='Verdana' size='3'>NO DATA RETURNED</font></td>"
				'			sBOM = sBOM & vbCrLf & "      </tr>"
				'		End If
				'		rsBOM2.Close
				'		Set rsBOM2 = Nothing
			...
			'Else
			'	sBOM = "    <font face='Verdana' size='5'>Bills of Material Report</font><br><font face='Verdana' size='3'>NO DATA RETURNED</font>"
			'End If
...
Function GetGloviaSQL(sRef, sParam1)
	...
	Select Case sRef
		Case "BOM1"
			If (sParam1 <> "") Then
				sSQL = "SELECT GLOVIA_PROD40.BOM.ITEM, GLOVIA_PROD40.ITEM_CCN.DRAW_REV, GLOVIA_PROD40.ITEM.DESCRIPTION "
		...
		Case "BOM2"
			If (sParam1 <> "") Then
				sSQL = "SELECT GLOVIA_PROD40.BOM.BOM_USEQ, GLOVIA_PROD40.BOM.COMP_ITEM, GLOVIA_PROD40.BOM.COMP_QTY, "
