...
Function GetRpt(sRpt, curEID, curUN, curSG)
	...
	Select Case sRpt
		Case "ToDoList"
			...
			sSQL = sSQL & "WHERE ProjStatus NOT IN ('CLS','REL')"
			If isAdmin=false then
				sSQL = sSQL & " AND AssignTo= " & curEID
			end If
			sSQL = sSQL & " ORDER BY PlannedFinish DESC"		
...
'   qfile.WriteLine "sSQL--" & sSQL
			...
			If Not ((rsToDo.BOF = True) And (rsToDo.EOF = True)) Then
				...
				sRet = sRet & vbCrLf & "    </tr>"
				sRet = sRet & vbCrLf & "    <tr>"
				sRet = sRet & vbCrLf & "    <td width='100%'><table class='table table-responsive table-bordered ' cellpadding='2' width='100%'>"
				sRet = sRet & vbCrLf & "      <tr>"
				sRet = sRet & vbCrLf & "        <td></td>"
				sRet = sRet & vbCrLf & "        <td>Project ID</td>"
				sRet = sRet & vbCrLf & "        <td>Project Name</td>"
				sRet = sRet & vbCrLf & "        <td>Status</td>"
				sRet = sRet & vbCrLf & "        <td>Actual Start Date</td>"
				sRet = sRet & vbCrLf & "        <td>Planned End Date</td>"
				sRet = sRet & vbCrLf & "      </tr>"
								
				rsToDo.MoveFirst				
				Do
					If Not IsNull(rsToDo("ProjNum")) Then					
						sLink = "<a href='../../ProjectManagement/ProjectInformation.aspx?SID=" & Session("SI") & "&PID=" & rsToDo("ProjNum") & "' target='_top'><svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' class='feather feather-search'><circle cx='11' cy='11' r='8'></circle><line x1='21' y1='21' x2='16.65' y2='16.65'></line></svg></a>"						
						sRet = sRet & vbCrLf & "      <tr>"
			...
			sSQL = sSQL & "(AssignTo = " & curEID & ") ORDER BY BFinish, TaskID"
			...
			If Not ((rsToDo.BOF = True) And (rsToDo.EOF = True)) Then
				...
				sRet = sRet & vbCrLf & "    </tr>"
				sRet = sRet & vbCrLf & "    <tr>"
				sRet = sRet & vbCrLf & "    <td width='100%'><table class='table table-borderless table-bordered ' border='0' cellpadding='2' width='100%'>"
				sRet = sRet & vbCrLf & "      <tr>"
				sRet = sRet & vbCrLf & "        <td></td>"
				sRet = sRet & vbCrLf & "        <td>Task ID</td>"
				sRet = sRet & vbCrLf & "        <td>Due Date</td>"
				sRet = sRet & vbCrLf & "        <td>Priority</td>"
				sRet = sRet & vbCrLf & "        <td>Description</td>"
				sRet = sRet & vbCrLf & "      </tr>"
								
				rsToDo.MoveFirst				
				Do
					If Not IsNull(rsToDo("TaskID")) Then					
						sLink = "<a href='../../TaskManagement/TaskInformation.aspx?SID=" & Session("SI") & "&TID=" & rsToDo("TaskID") & "' target='_top'><svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' class='feather feather-search'><circle cx='11' cy='11' r='8'></circle><line x1='21' y1='21' x2='16.65' y2='16.65'></line></svg></a>"						
						sRet = sRet & vbCrLf & "      <tr>"
						sRet = sRet & vbCrLf & "        <td valign='top'><font face='Verdana' size='2'>" & sLink & "</font></td>"
			...
			sSQL = "SELECT WATID, TaskID, RefType, RefNum, Priority, TaskDesc, BFinish, WATType, WFAssnTo FROM ViewWFTasks WHERE (WFActive <> 0) AND (WATActive <> 0) AND (AssignTo = " & curEID & ") ORDER BY BFinish, TaskID"
			ELSE
			...
			If Not ((rsToDo.BOF = True) And (rsToDo.EOF = True)) Then			
				...
				sRet = sRet & vbCrLf & "  </tr>"
				sRet = sRet & vbCrLf & "  <tr>"
				sRet = sRet & vbCrLf & "    <td width='100%'><table class='table table-bordered  table-responsive'  cellpadding='2' width='100%'>"
				sRet = sRet & vbCrLf & "      <tr>"
				sRet = sRet & vbCrLf & "        <td></td>"
				sRet = sRet & vbCrLf & "        <td>Task ID</td>"
				sRet = sRet & vbCrLf & "        <td>Due Date</td>"
				...
				Do				
					If Not IsNull(rsToDo("TaskID")) Then											
						sLink = "<a href='../../WorkFlowManagement/WFTaskInformation.aspx?SID=" & Session("SI") & "&RFTP=" & rsToDo("RefType") &  "&RFID=" & rsToDo("RefNum") & "&TID=" & rsToDo("WATID") & "' target='_top'><svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' class='feather feather-search'><circle cx='11' cy='11' r='8'></circle><line x1='21' y1='21' x2='16.65' y2='16.65'></line></svg></a>"					
						sLink =  sLink & vbCrLf & "<a href='../../WorkFlowManagement/WFTaskInformationReview.aspx?SID=" & Session("SI") & "&RFTP=" & rsToDo("RefType") &  "&RFID=" & rsToDo("RefNum") & "&TID=" & rsToDo("WATID") & "' target='_top'><img src='../graphics/Task.png' alt='Update' border='0' WIDTH='18' HEIGHT='18'></a>"						
						sRet = sRet & vbCrLf & "      <tr>"
						sRet = sRet & vbCrLf & "        <td valign='top'><font face='Verdana' size='2'>" & sLink & "</font></td>"
						sRet = sRet & vbCrLf & "        <td valign='top'><font face='Verdana' size='2'><strong>" & rsToDo("TaskID") & "</strong></font></td>"
						sRet = sRet & vbCrLf & "        <td valign='top'><font face='Verdana' size='2'>" & rsToDo("BFinish") & "</font></td>"
			...
			'Set qfile = fso.OpenTextFile("D:\qtptest.txt",2,True)
			'qfile.WriteLine "sSQL--" & sSQL
			'qfile.WriteLine "sSQL--" & curEID
			'qfile.WriteLine "sSQL--" & curUN
			...
			If Not ((rsToDo.BOF = True) And (rsToDo.EOF = True)) Then			
				...
				sRet = sRet & vbCrLf & "      <tr>"
				sRet = sRet & vbCrLf & "        <td></td>"
				sRet = sRet & vbCrLf & "        <td>Change Num</td>"
				sRet = sRet & vbCrLf & "        <td>Due Date</td>"
				sRet = sRet & vbCrLf & "        <td>Priority</td>"
				sRet = sRet & vbCrLf & "        <td>Description</td>"
				sRet = sRet & vbCrLf & "      </tr>"
				...
				Do
					...
					sLink = "<a href='../../ChangeManagement/ChangeOrders.aspx?SID=" & Session("SI") & "&COID=" & rsToDo("CO") & "' target='_top'><svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' class='feather feather-search'><circle cx='11' cy='11' r='8'></circle><line x1='21' y1='21' x2='16.65' y2='16.65'></line></svg></a>"					
			...
			If Not ((rsToDo.BOF = True) And (rsToDo.EOF = True)) Then			
				...
				sRet = sRet & vbCrLf & "      <tr>"
				sRet = sRet & vbCrLf & "        <td></td>"
				sRet = sRet & vbCrLf & "        <td>Document ID</td>"
				sRet = sRet & vbCrLf & "        <td>Description</td>"
				sRet = sRet & vbCrLf & "        <td>Project ID</td>"
				sRet = sRet & vbCrLf & "        <td>Requested Date</td>"
				sRet = sRet & vbCrLf & "        <td>Status</td>"
				sRet = sRet & vbCrLf & "      </tr>"
				...
				Do
					If Not IsNull(rsToDo("DocID")) Then											
						sLink = "<a href='../../DocumentManagement/DocInformation.aspx?SID=" & Session("SI") & "&DOCID=" & rsToDo("DocID") & "' target='_top'><svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' class='feather feather-search'><circle cx='11' cy='11' r='8'></circle><line x1='21' y1='21' x2='16.65' y2='16.65'></line></svg></a>"						
	...
	'qfile.WriteLine "sSQL--" & sSQL
			  ...
			  Select Case curSG
				Case 1, 3, 8, 9
					...
					If Not ((rsToDo.BOF = True) And (rsToDo.EOF = True)) Then
						...
						sRet = sRet & vbCrLf & "        <td>Task ID</td>"
						sRet = sRet & vbCrLf & "        <td>Due Date</td>"
						sRet = sRet & vbCrLf & "        <td>Assigned To</td>"
						sRet = sRet & vbCrLf & "        <td>Priority</td>"
						sRet = sRet & vbCrLf & "        <td>Description</td>"
						sRet = sRet & vbCrLf & "      </tr>"
					...
					sSQL = "SELECT TaskID, WATID, RefType, RefNum, Priority, TaskDesc, BFinish, WATType, WFGroups.WFGroup AS WFAssnTo, ULNF FROM ViewWFTasks LEFT JOIN WFGroups ON WFGroups.WFGID = ViewWFTasks.WFAssnTo"
					sSQL = sSQL & " WHERE ((WFActive <> 0) AND (WATActive <> 0)) AND (WFAssnTo <> " & curEID & ") ORDER BY BFinish, TaskID"
					...
					If Not ((rsToDo.BOF = True) And (rsToDo.EOF = True)) Then
						...
						Do
							...
							sLink = sLink & vbCrLf & "<a href='../../WorkFlowManagement/WFTaskInformationReview.aspx?SID=" & Session("SI") & "&RFTP=" & rsToDo("RefType") &  "&RFID=" & rsToDo("RefNum") & "&TID=" & rsToDo("WATID") & "' target='_top'><img src='../graphics/Task.png' alt='Update' border='0' WIDTH='18' HEIGHT='18'></a>"
								...
								sRet = sRet & vbCrLf & "        <td valign='top'><font face='Verdana' size='2'>" & rsToDo("BFinish") & "</font></td>"
								sRet = sRet & vbCrLf & "        <td valign='top'><font face='Verdana' size='2'>" & rsToDo("WFAssnTo") & "</font></td>"
								sRet = sRet & vbCrLf & "        <td valign='top'><font face='Verdana' size='2'>" & rsToDo("Priority") & "</font></td>"
								sRet = sRet & vbCrLf & "        <td valign='top'><font face='Verdana' size='2'>" & rsToDo("TaskDesc") & "</font></td>"
								sRet = sRet & vbCrLf & "      </tr>"
					...
					If Not ((rsToDo.BOF = True) And (rsToDo.EOF = True)) Then
						...
						sRet = sRet & vbCrLf & "        <td>Change Num</td>"
						sRet = sRet & vbCrLf & "        <td>Due Date</td>"
						sRet = sRet & vbCrLf & "        <td>Assigned</td>"
						sRet = sRet & vbCrLf & "        <td>Priority</td>"
						sRet = sRet & vbCrLf & "        <td>Description</td>"
						sRet = sRet & vbCrLf & "      </tr>"
					...
					sSQL = "SELECT a.HD_ID, a.RequestNo as RequestNo,a.Status,a.RequestType,a.RequestDate,a.Department,a.Supervisor,a.DueDate,a.Project,a.Description "
					sSQL = sSQL & "FROM HelpDesk a where a.RequestBy='" & curUN & "'"
					...
					If Not ((rsToDo.BOF = True) And (rsToDo.EOF = True)) Then
						...
						sRet = IIf(sRet <> "", sRet & vbCrLf, "") & "  <tr>"
						sRet = sRet & vbCrLf & "    <td width='100%' align='center' bgcolor='#C0C0C0'><strong><font face='Verdana'>Help Tickits</font></strong></td>"
						sRet = sRet & vbCrLf & "  </tr>"
						sRet = sRet & vbCrLf & "  <tr>"
						sRet = sRet & vbCrLf & "    <td width='100%'><table class='table table-bordered table-responsive' cellpadding='2' width='100%'>"
						sRet = sRet & vbCrLf & "      <tr>"
						sRet = sRet & vbCrLf & "        <td></td>"
						sRet = sRet & vbCrLf & "        <td>HD ID</td>"
						sRet = sRet & vbCrLf & "        <td>Request No</td>"
						sRet = sRet & vbCrLf & "        <td>Status</td>"
						sRet = sRet & vbCrLf & "        <td>Request Type</td>"
						sRet = sRet & vbCrLf & "        <td>Request Date</td>"
						sRet = sRet & vbCrLf & "        <td>Department</td>"
						sRet = sRet & vbCrLf & "        <td>Supervisor</td>"
						sRet = sRet & vbCrLf & "        <td>Due Date</td>"
						sRet = sRet & vbCrLf & "        <td>Project</td>"
						sRet = sRet & vbCrLf & "        <td>Description</td>"
						sRet = sRet & vbCrLf & "      </tr>"
						...
						Do
							If Not IsNull(rsToDo("HD_ID")) Then
							
							
							sLink = "<a href='../../ChangeManagement/Helpdesk.aspx?SID=" & Session("SI") & "&COID=" & rsToDo("HD_ID") & "' target='_top'><svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' class='feather feather-search'><circle cx='11' cy='11' r='8'></circle><line x1='21' y1='21' x2='16.65' y2='16.65'></line></svg></a>"
																
								sRet = sRet & vbCrLf & "      <tr>"
								sRet = sRet & vbCrLf & "        <td valign='top'><font face='Verdana' size='2'>" & sLink & "</font></td>"
								sRet = sRet & vbCrLf & "        <td valign='top'><font face='Verdana' size='2'><strong>" & rsToDo("HD_ID") & "</strong></font></td>"
								sRet = sRet & vbCrLf & "        <td valign='top'><font face='Verdana' size='2'>" & rsToDo("RequestNo") & "</font></td>"
								sRet = sRet & vbCrLf & "        <td valign='top'><font face='Verdana' size='2'>" & rsToDo("Status") & "</font></td>"
								sRet = sRet & vbCrLf & "        <td valign='top'><font face='Verdana' size='2'>" & rsToDo("RequestType") & "</font></td>"
								sRet = sRet & vbCrLf & "        <td valign='top'><font face='Verdana' size='2'>" & rsToDo("RequestDate") & "</font></td>"
								sRet = sRet & vbCrLf & "        <td valign='top'><font face='Verdana' size='2'>" & rsToDo("Department") & "</font></td>"
								sRet = sRet & vbCrLf & "        <td valign='top'><font face='Verdana' size='2'>" & rsToDo("Supervisor") & "</font></td>"
								sRet = sRet & vbCrLf & "        <td valign='top'><font face='Verdana' size='2'>" & rsToDo("DueDate") & "</font></td>"
								sRet = sRet & vbCrLf & "        <td valign='top'><font face='Verdana' size='2'>" & rsToDo("Project") & "</font></td>"
								sRet = sRet & vbCrLf & "        <td valign='top'><font face='Verdana' size='2'>" & rsToDo("Description") & "</font></td>"
								sRet = sRet & vbCrLf & "      </tr>"
					...
					Else
						sRet = IIf(sRet <> "", sRet & vbCrLf, "") & "  <tr>"
						sRet = sRet & vbCrLf & "    <td width='100%' bgcolor='#C0C0C0'><font face='Verdana'>No Help Desk Tickits found</font></td>"
						sRet = sRet & vbCrLf & "  </tr>"
					End If
					rsToDo.Close
			...
			'=============================
			If (sRet <> "") Then
				sRet = "<table class='table table-borderless table-responsive' border='0' cellpadding='2' width='625' cellspacing='2'>" & vbCrLf & sRet & vbCrLf & "</table>"
			Else
	...
	Select Case vItem
		Case "List"
            ...
            If Not ((rsItem.BOF = True) And (rsItem.EOF = True)) Then
				sBody  = "    <table class='table table-borderless table-responsive' width='500' cellpadding='0' cellspacing='0' border='0'>"
		...
		Case "Search"
            ...
            If Not ((rsFields.BOF = True) And (rsFields.EOF = True)) Then
				sBody = sBody & vbCrLf & "    <table class='table table-borderless table-responsive' width='300' cellpadding='5' cellspacing='0' border='0'>"
...
Function GetHTMLBody(vTag)
    ...
    Select Case vTag
        Case "SuppCont", "SuppLinks"
			...
			sBody = sBody & "    <p align='center'><font face='Verdana' size='6'><strong>ERMS</strong><em>app</em></font><font face='Verdana' size='2'><br>" 
			sBody = sBody & "    <strong>Engineering Resource Management System - Version 20.2<br>" 
			sBody = sBody & "    </strong></font><font face='Verdana' size='1'>©2001-2022, Sky5 Solutions. All Rights Reserved.</font></p>" 
			sBody = sBody & "    <div align='center'><center><table class='table table-borderless table-responsive' border='0' cellpadding='4' width='480'>" 
			sBody = sBody & "      <tr>" 
			sBody = sBody & "        <td valign='top' align='right'><strong><font face='Verdana' size='2'>Sky5 Solutions</font></strong></td>" 
			sBody = sBody & "        <td valign='top'><font face='Verdana' size='2'><strong><a href='http://www.Sky5solutions.com'>www.Sky5solutions.com</a></strong></font></td>" 
			sBody = sBody & "      </tr>" 
			sBody = sBody & "      <tr>" 
			sBody = sBody & "        <td valign='top' align='right'><strong><font face='Verdana' size='2'>Customer Care</font></strong></td>" 
			sBody = sBody & "        <td valign='top'><font face='Verdana' size='2'><strong><a href='mailto:Csharp@sky5solutions.net'>Chuck Sharp</a></strong> • (972) 663-5426</font></td>" 
			sBody = sBody & "      </tr>" 
			sBody = sBody & "      <tr>" 
			sBody = sBody & "        <td valign='top' align='right'><strong><font face='Verdana' size='2'>Technical Support</font></strong></td>" 
			sBody = sBody & "        <td valign='top'><font face='Verdana' size='2'><strong><a href='mailto:Support@sky5solutions.net'>Support</a></strong> • (972) 663-5426</font></td>" 
			sBody = sBody & "      </tr>" 
			sBody = sBody & "    </table>" 
    ...
    Select Case vItem
        Case "Doc"
			...
			If (val1 = True) Then
				...
				sItem = "<div><table class='table table-borderless table-responsive' border='1' width='625' cellpadding='2' cellspacing='1'>"
				...
				If (vOpt = "") Then
					...
					Select Case val4
						Case "484", "485", "486"
							...
							If (val4 <> "") Then
								sLink = "<a href='ret_selitem.asp?Listing=Doc&Item=" & sItemVal & "&Opt=0001'>PART ATTRIBUTE LISTING</a>"
								sItem = sItem & vbCrLf & "      <tr>"
								sItem = sItem & vbCrLf & "        <td width='100%'><font face='Verdana' size='2'><strong>" & sLink & "</strong></font></td>"
								sItem = sItem & vbCrLf & "      </tr>"
							End If
						...
						Case "484", "485", "486"
							...
							If (val5 <> "") Then
								If (Mid(vOpt, 4,1) = "0") Then
									val2 = Left(vOpt, 3) & "1"
									sLink = "<a href='ret_selitem.asp?Listing=Doc&Item=" & sItemVal & "&Opt=" & val2 & "'>PART ATTRIBUTE LISTING</a>"
				...
				'			sLink = "<a href='ret_doc_info.asp?Item=" & sItemVal & "'>PART ATTRIBUTE LISTING</a>"
				'			sItem = sItem & vbCrLf & "      <tr>"
				'			sItem = sItem & vbCrLf & "        <td width='100%'><font face='Verdana' size='2'><strong>" & sLink & "</strong></font></td>"
				'			sItem = sItem & vbCrLf & "      </tr>"
				'		End If
		...
		'	sItem = sItem & "<div><table class='table table-borderless table-responsive' border='0' width='625' cellpadding='2' cellspacing='0'>"
		'	sItem = sItem & vbCrLf & "  <tr>"
		'	sItem = sItem & vbCrLf & "    <td><table class='table table-borderless table-responsive' border='0' width='100%' cellpadding='2'>"
		'	sItem = sItem & vbCrLf & "      <tr>"
		'	sItem = sItem & vbCrLf & "        <td><font face='Verdana' size='4'><strong><span style='text-decoration: underline'>PART ATTRIBUTE LISTING</span></strong></font></td>"
		'	sItem = sItem & vbCrLf & "      </tr>"
		'	sItem = sItem & vbCrLf & "    </table>"
		'	sItem = sItem & vbCrLf & "    </td>"
		'	sItem = sItem & vbCrLf & "  </tr>"
		'	sItem = sItem & vbCrLf & "  <tr>"
		'	sItem = sItem & vbCrLf & "    <td><table class='table table-borderless table-responsive' border='0' width='100%' cellpadding='2' cellspacing='0'>"
        ...
        Case "Change"
			...
			If (val1 = True) Then
				...
				sItem = sItem & vbCrLf & GetInfoSection("ChangeImpact", sItemVal, "", "")
        ...
        Case "Part"
            ...
            If Not ((rsItem.BOF = True) And (rsItem.EOF = True)) Then
				...
				If Not IsNull(rsItem("PartNo")) Then
					...
					sItem = "<div><table class='table table-borderless table-responsive' border='1' width='625' cellpadding='2' cellspacing='1'>"
					sItem = sItem & vbCrLf & "  <tr>"
					sItem = sItem & vbCrLf & "    <td width='100%' bgcolor='#808000'><table class='table table-borderless table-responsive' border='0' width='100%' cellpadding='2'>"
					sItem = sItem & vbCrLf & "      <tr>"
					...
					sItem = sItem & vbCrLf & "  </tr>"
					sItem = sItem & vbCrLf & "  <tr>"
					sItem = sItem & vbCrLf & "    <td width='100%'><table class='table table-borderless table-responsive' border='0' width='100%' cellpadding='2'>"
					sItem = sItem & vbCrLf & "      <tr>"
					...
					sItem = sItem & vbCrLf & "  </tr>"
					sItem = sItem & vbCrLf & "  <tr>"
					sItem = sItem & vbCrLf & "    <td width='100%'><table class='table table-borderless table-responsive' border='0' cellpadding='2' width='100%'>"
					sItem = sItem & vbCrLf & "      <tr>"
        ...
        Case "Project"
            ...
            If Not ((rsItem.BOF = True) And (rsItem.EOF = True)) Then
				...
				If Not IsNull(rsItem("ProjNum")) Then
					...
					sItem = sItem & vbCrLf & "  </tr>"
					sItem = sItem & vbCrLf & "  <tr>"
					sItem = sItem & vbCrLf & "    <td width='100%'><table class='table table-borderless table-responsive' border='0' cellpadding='2'>"
					sItem = sItem & vbCrLf & "      <tr>"
