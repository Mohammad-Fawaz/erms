...
sList = GetWFSelect("WActions", "", "")

%>

<link rel="stylesheet" type="text/css" href="../pg_style.css">
<title>Modify Workflow Action</title>
</head>
...
<table border="0" cellpadding="2" cellspacing="0" width="780">
  <tr>
    <td width="635" valign="top"><font face="Verdana" size="5">Edit/Modify Workflow Action</font><p><font face="Verdana" size="2">Please select an action from the supplied list to open the record
    for modification.</font></p>
    <form method="POST" action="wf_add_act.asp">
      <input type="hidden" name="Mode" value="RU"><div align="center"><center><table border="0" cellpadding="2" cellspacing="0" width="100%">
        <tr>
          <td align="right" nowrap><font face="Verdana" size="2"><strong>Action Name:</strong></font></td>
...
<% =sList %>            
        ...
        <tr>
          <td align="center" valign="top" colspan="2"><input type="submit" value="Open Action" name="B1"></td>
        </tr>
      </table>
      </center></div>
    </form>
