<%@ Page Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="AddSub_RoleModule.aspx.cs" Inherits="AddSub_RoleModule" Title="Role Module" %>
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                       ...
                                       <asp:Button  runat="server" ID="btn_BackMainPage" Text="Go Back" OnClick="btn_BackMainPage_Click" CssClass="float-right btn btn-outline-primary m-1"/>
                                       </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <asp:GridView ID="GridView1"  runat="server" OnRowDataBound="GridView1_RowDataBound" AutoGenerateColumns="False" DataKeyNames="MenuId" CssClass="table table-bordered table-condensed table-responsive table-hover">
    <Columns>
        ...
        <asp:TemplateField HeaderText="Page Name">
            <ItemTemplate>
                <asp:Label ID="Label2" runat="server" Text='<%#Bind("Title") %>'></asp:Label>
                 <asp:HiddenField  runat="server" ID="hfd_childId" Value='<%#Bind("MenuId") %>'/>
        ...
        <asp:TemplateField HeaderText="Mark Sub Menu" Visible="false">
            <ItemTemplate>
                <asp:LinkButton runat="server" ID="lnkbtn_AddSubChild" OnClick="lnkbtn_AddSubChild_Click" Text="Mark SubMenu" CommandArgument='<%#Bind("MenuId") %>'></asp:LinkButton>
      ...
      <asp:TemplateField >
        ...
        Text="Save" /> 
                                                                          <asp:Button ID="btn_dlt" runat="server"    CssClass="btn btn-outline-primary m-1" onclick="btn_dlt_Click"   
        Text="Delete" />
